...
public class OpernInfo implements Serializable {
    ...
    private List<OpernPicInfo> opernPicInfoList;
    ...
    public List<OpernPicInfo> getOpernPicInfoList() {
        return opernPicInfoList;
    }

    public void setOpernPicInfoList(List<OpernPicInfo> opernPicInfoList) {
